...
function ChevronLeft() {
    return (jsxRuntime.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", fill: "currentColor", className: "bi bi-chevron-left", viewBox: "0 0 16 16", children: jsxRuntime.jsx("path", { fillRule: "evenodd", d: "M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0" }) }));
}
function ChevronRight() {
    return (jsxRuntime.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", fill: "currentColor", className: "bi bi-chevron-right", viewBox: "0 0 16 16", children: jsxRuntime.jsx("path", { fillRule: "evenodd", d: "M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708" }) }));
}
...
const Calendar = ({ dir = "ltr", CalendarType = "gregorian", firstDayOfWeek = 6, onChange, renderDay, classNames, components, }) => {
    ...
    return (jsxRuntime.jsx("div", { className: `calendar-app ${classNames?.root ?? ""}`, dir: dir, children: jsxRuntime.jsxs("div", { className: `calendar ${classNames?.header ?? ""}`, children: [jsxRuntime.jsxs("div", { className: `navigate-date ${classNames?.nav ?? ""}`, children: [jsxRuntime.jsxs("h2", { className: `month ${classNames?.month ?? ""}`, children: [CalendarType === "gregorian"
                                    ? monthsEn[current.month()]
                                    : monthsFa[current.month()], " ", "\u060C"] }), jsxRuntime.jsx("h2", { className: `year ${classNames?.year ?? ""}`, children: CalendarType === "gregorian" ? current.year() : current.year() }), jsxRuntime.jsxs("div", { className: "buttons", children: [components?.PrevButton ? (components.PrevButton({ onClick: prevMonth, dir })) : (jsxRuntime.jsx("button", { onClick: prevMonth, children: dir === "ltr" ? jsxRuntime.jsx(ChevronLeft, {}) : jsxRuntime.jsx(ChevronRight, {}) })), components?.NextButton ? (components.NextButton({ onClick: nextMonth, dir })) : (jsxRuntime.jsx("button", { onClick: nextMonth, children: dir === "ltr" ? jsxRuntime.jsx(ChevronRight, {}) : jsxRuntime.jsx(ChevronLeft, {}) }))] })] }), jsxRuntime.jsx("div", { className: `weekdays ${classNames?.weekdays ?? ""}`, children: getDaysOfWeek(CalendarType, firstDayOfWeek).map((day) => (jsxRuntime.jsx("span", { className: classNames?.weekday ?? "", children: day }, day))) }), jsxRuntime.jsxs("div", { className: `days ${classNames?.days ?? ""}`, children: [prevMonthDays.map((day, i) => {
                            const showMonth = i === 0;
                            ...
                            return (jsxRuntime.jsx("span", { className: `defaultDays ${classNames?.lastMonth ?? "disabled"}`, onClick: () => handleSelectDate(prevDayDate), children: i === 0
                            ...
                            return (jsxRuntime.jsx("span", { className: day + 1 === current.date()
                                    ? `${classNames?.currentDay ?? "current-day"} defaultDays`
                                    : `${classNames?.day ?? "defaultDays"}`, onClick: () => handleSelectDate(dayDate), children: i === 0 ? (jsxRuntime.jsx("span", { children: `${day + 1} ${CalendarType === "jalali"
                            ...
                            return (jsxRuntime.jsx("span", { className: `defaultDays ${classNames?.nextMonth ?? "disabled"}`, onClick: () => handleSelectDate(nextDayDate), children: i === 0
                                    ? `${day} ${CalendarType === "jalali"
